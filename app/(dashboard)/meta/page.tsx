...
export default function MetaPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const [account, daily, campaigns, chatList] = await Promise.all([
  ...
  const totals = useMemo(() => sumInsights(accountRows), [accountRows]);
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <ConversationsAreaChart data={conversationsByDay} />
          </div>
